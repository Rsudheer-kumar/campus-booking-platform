        ...
        <div className="flex flex-col xl:flex-row gap-6 xl:h-[650px]">
          ...
          >
            ...
            <div className="absolute top-4 left-4 z-10 select-none pointer-events-none">
              <h3 className="text-foreground/90 font-semibold tracking-tight text-sm drop-shadow-md">
                Campus Digital Twin
              </h3>
              <p className="text-muted/80 text-xs drop-shadow-md">
                Click any facility to view live status
              </p>
            </div>
            ...
            <Card
              className={cn(
                ...
                selectedBuildingData
                  ? "border-primary/40 shadow-[0_0_40px_rgba(79,140,255,0.06)] bg-gradient-to-b from-[#0B1527] to-surface relative"
                  : "",
              )}
            >
              {selectedBuildingData && (
                <div className="absolute top-0 left-0 w-full h-[2px] bg-primary/70 animate-pulse-soft" />
              )}
              {selectedBuildingData ? (
                <div className="h-full flex flex-col animate-fade-in space-y-5">
                  <div className="space-y-1">
                    <div className="flex items-start justify-between gap-2">
                      ...
                      <Badge
                        variant={
                          selectedBuildingData.utilization > 90
                            ? "occupied"
                            : "available"
                        }
                        dot
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="surface rounded-[var(--radius-sm)] p-3">
                      ...
                      <p className="text-2xl font-semibold text-foreground">
                        {selectedBuildingData.utilization}%
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="surface-elevated rounded-[var(--radius-md)] p-4 flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-muted mt-0.5">
                        {selectedBuildingData.maint} active tickets
                      </p>
                    </div>
                    <Badge
                      variant={
                        selectedBuildingData.maint > 0 ? "warning" : "success"
                      }
                    >
                ...
                <div className="h-full flex flex-col items-center justify-center text-center animate-fade-in">
                  ...
                  <p className="text-sm text-muted mt-2 max-w-[250px]">
                    Interact with the digital twin to inspect facility status,
                    resource bookings, and usage statistics.
                  </p>
                </div>
              )}
            </Card>
